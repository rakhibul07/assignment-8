  ...
  return (
    <div>
      ...
      style={{backgroundColor: card_bg}}>
        ...
        <div className="lg:space-y-2 px-4 py-4">
          ...
          <Link to={`/cards/${id}`}><button className="text-white p-2 rounded-md" style={{backgroundColor:text_color}}>View Details</button></Link>
        </div>
      </div>
    </div>
  );
