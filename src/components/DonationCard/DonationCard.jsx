...
const DonationCard = ({ card }) => {
  ...
  return (
    <div>
      <div
        className=" lg:flex gap-8 rounded-lg  items-center mx-4 lg:mx-0 "
        style={{ backgroundColor: card_bg }}
      >
        <div>
          <img src={picture} className="rounded-lg rounded-r-none w-full " />
        </div>
        <div className="px-4 py-4 space-y-1">
          ...
          <Link to={`/cards/${id}`}>
            <button
              className="text-white mt-2 px-2 py-1 rounded-md"
